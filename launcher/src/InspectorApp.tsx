  ...
  return (
    ...
    >
      ...
      >
        ...
        {[{ id: 'performance', icon: Monitor, label: 'Performance' }].map(
          (tab) => (
            <button
              key={tab.id}
              ...
              >
                {[
                  ...
                  { label: 'OS', val: hardware ? hardware.os : 'Loading...' },
                  {
                    label: 'Engine',
                    val: hardware
                      ? `Chromium ${hardware.chromeVersion}`
                      : 'Loading...',
                  },
                ].map((item, i) => (
                  <div
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: 'bold',
                        color:
                          (telemetry?.fps || 0) > 40 ? '#34d399' : '#f87171',
                      }}
                    >
                      {telemetry?.fps || 0}
                    </div>
                    ...
                    >
                      1% Low: {telemetry?.onePercentLowFPS || 0} FPS
                    </div>
                  </div>
                  <div
                    style={{
                        ...
                        {telemetryHistory.length > 1 && (
                          <polyline
                            ...
                            points={telemetryHistory
                              .map(
                                (t, i) =>
                                  `${(i / 30) * 300},${100 - (Math.min(t.fps, 100) / 100) * 100}`,
                              )
                              .join(' ')}
                          />
                        )}
                  ...
                  >
                    ...
                    >
                      ...
                      {telemetry?.domStats?.total > 1500 && (
                        ...
                        >
                          <strong>Warning:</strong> Deep DOM detected (
                          {telemetry.domStats.total} nodes). This causes heavy
                          layout recalcs.
                        </div>
                      )}
                      {features.blur && (
                        ...
                        >
                          <strong>Recommendation:</strong> Disabling
                          backdrop-blur can yield +15-20 FPS on Low End PCs.
                        </div>
                      )}
                    </div>
                  </div>
