...
export default function FriendsHub() {
  ...
  >([
    {
      sender: 'them',
      text: 'Hey, want to play some bedwars?',
      time: '2:30 PM',
    },
    {
      sender: 'me',
      text: 'Sure, let me just finish this game first',
      time: '2:32 PM',
    },
    {
      sender: 'them',
      text: 'Awesome, invite me when you are ready.',
      time: '2:33 PM',
    },
  ]);
  ...
  const [friendsData, setFriendsData] = useState([
    {
      id: 1,
      name: 'xEradicator',
      tag: 'Playing Bedwars on Hypixel',
      status: 'online',
      avatar: getPlayerAvatar('xEradicator'),
      type: 'friend',
    },
    {
      id: 2,
      name: 'EC_Revamp',
      tag: 'Last seen 2h ago',
      status: 'offline',
      avatar: getPlayerAvatar('EC_Revamp'),
      type: 'friend',
    },
    {
      id: 3,
      name: 'Technoblade',
      tag: 'Playing Skyblock',
      status: 'online',
      avatar: getPlayerAvatar('Technoblade'),
      type: 'friend',
    },
    {
      id: 4,
      name: 'Notch',
      tag: 'Playing Minecraft 1.0',
      status: 'online',
      avatar: getPlayerAvatar('Notch'),
      type: 'friend',
    },
    {
      id: 5,
      name: 'Grian',
      tag: 'Building in Hermitcraft',
      status: 'online',
      avatar: getPlayerAvatar('Grian'),
      type: 'friend',
    },
    {
      id: 6,
      ...
      tag: 'Redstoning',
      status: 'offline',
      avatar: getPlayerAvatar('MumboJumbo'),
      type: 'friend',
    },
    {
      id: 7,
      name: 'AtyachariAlt',
      tag: 'Incoming Friend Request',
      status: 'offline',
      avatar: getPlayerAvatar('Atyachari'),
      type: 'pending',
    },
    {
      id: 8,
  ...
  const handleBlock = (id: number) => {
    setFriendsData((prev) =>
      prev.map((f) => (f.id === id ? { ...f, type: 'blocked' } : f)),
    );
  ...
  if (activeTab === 'Online') {
    displayFriends = friendsData.filter(
      (f) => f.status === 'online' && f.type === 'friend',
    );
        ...
        {activeChat ? (
          ...
          >
            ...
            >
              ...
              >
                <input
                  type="text"
                  placeholder={`Message @${friendsData.find((f) => f.id === activeChat)?.name}`}
                  value={chatInput}
          ...
          >
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>
              You can add friends with their Minecraft username.
            </p>
            <div style={{ display: 'flex', gap: '12px', maxWidth: '600px' }}>
              ...
              <button
                ...
                style={{
                  padding: '0 24px',
                  borderRadius: '8px',
                  opacity: addFriendInput.trim() ? 1 : 0.5,
                  cursor: addFriendInput.trim() ? 'pointer' : 'not-allowed',
                }}
              >
                Send Friend Request
              </button>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    >
                      <CircleDot
                        ...
                        fill={
                          friend.status === 'online' ? '#10b981' : 'transparent'
                        }
                      />
                    </div>
                  </div>
                    ...
                    <>
                      ...
                      <div style={{ position: 'relative' }}>
                        <button
                          onClick={() =>
                            setDropdownMenuId(
                              dropdownMenuId === friend.id ? null : friend.id,
                            )
                          }
                          className="btn-lift"
                          style={{
                        ...
                        {dropdownMenuId === friend.id && (
                          <>
                            <div
                              ...
                              onClick={() => setDropdownMenuId(null)}
                            />
                            <div
