    ...
    <div style={{ position: 'relative', width }} onClick={() => setOpen(!open)}>
      <div
        ...
        style={{
          ...
          boxShadow: open ? '0 0 0 2px rgba(168, 85, 247, 0.2)' : 'none',
        }}
      >
        {value}
        <ChevronDown
            ...
            {options.map((opt) => (
              <div
                ...
                style={{
                  ...
                  color: opt === value ? 'var(--accent-primary)' : 'white',
...
export default function Settings({
  ...
  const [launchBehavior, setLaunchBehavior] = useLocalStorage(
    'settings_launchBehavior',
    'Keep launcher open',
  );
  ...
  const [allocatedMemory, setAllocatedMemory] = useLocalStorage(
    'settings_allocatedMemory',
    '4',
  );
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  border: 'none',
                  background: activeTab === tab.id ? '#25262b' : 'transparent',
                  color:
            ...
            {activeTab === 'General' && (
              <>
                ...
                >
                  ...
                  >
                    What should the launcher do when the game starts?
                  </p>
                ...
                >
                  ...
                  <p
                    style={{ color: 'var(--text-secondary)', fontSize: '13px' }}
                  >
                    Enable GPU acceleration for smoother launcher animations.
                    Disable if you experience graphical glitches.
                  </p>
                  <label
                    style={{
                      display: 'flex',
            ...
            {activeTab === 'Game' && (
              <>
                <div>
                  ...
                  >
                    Disable all blurred backgrounds, heavy CSS animations, and
                    background videos to maximize client performance.
                  </p>
                  <label
                    style={{
                      display: 'flex',
                ...
                <div>
                  ...
                  >
                    How much RAM should be allocated to the game instance.
                  </p>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  <input
                    ...
                    onChange={(e) => setAllocatedMemory(e.target.value)}
                    style={{ width: '100%' }}
                  />
                  <div
                    style={{
                ...
                <div>
                  ...
                  >
                    Set the default window size for Minecraft.
                  </p>
                  <div
                    style={{
                      display: 'flex',
            ...
            {activeTab === 'Account' && (
              <>
                <div>
                  ...
                  >
                    <img
                      src="https://minotar.net/helm/Atyachari/64.png"
                      alt="Avatar"
                      style={{
                        width: '48px',
                        height: '48px',
                    ...
                    >
                      <LogOut size={14} style={{ marginRight: '8px' }} /> Log
                      Out
                    </button>
                  </div>
                </div>
            ...
            {activeTab === 'Storage' && (
              <>
                <div>
                  ...
                  >
                    Where game instances, mods, and assets are saved.
                  </p>
                  <div style={{ display: 'flex', gap: '12px' }}>
                    <input
                      ...
                      type="text"
                      readOnly
                      value="C:\Users\Atyachari\AppData\Roaming\.customclient"
                      style={{
                        flex: 1,
                        fontSize: '13px',
                        fontFamily: 'monospace',
                ...
                <div>
                  ...
                  >
                    Clear downloaded assets, images, and mod indices to free up
                    space. (Estimated size: ~1.2 GB)
                  </p>
                  <button
                    className="btn btn-lift"
                    style={{
            ...
            {activeTab === 'Notifications' && (
              <>
                <div>
                  ...
                  >
                    Receive OS-level notifications for important events.
                  </p>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <span style={{ fontSize: '14px' }}>
                        Notify when a Modpack has an update available
                      </span>
                    </label>
                    <label
                      style={{
                ...
                <div style={{ marginTop: '16px' }}>
                  ...
                  >
                    ...
                    />
                    <span style={{ fontSize: '14px' }}>
                      Play sound when game successfully launches
                    </span>
                  </label>
                </div>
              </>
            ...
            {activeTab === 'Privacy' && (
              <>
                ...
                <div style={{ marginTop: '16px' }}>
                  ...
                  >
                    Help us improve the launcher by sending anonymous usage and
                    crash data.
                  </p>
                  <label
                    style={{
