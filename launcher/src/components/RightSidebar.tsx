...
export default function RightSidebar() {
  ...
  const friends = [
    { name: 'xEradicator', tag: 'Playing Bedwars', status: 'Online', avatar: 'https://crafatar.com/avatars/41c82c877afb4024ba5713d2c99cae77?size=32&overlay' },
    { name: 'EC_Revamp', tag: 'Last seen 2h ago', status: 'Offline', avatar: 'https://crafatar.com/avatars/b4b3b185605d41f3b069d30026eef469?size=32&overlay' }
  ];
  ...
  return (
    <aside className="glass" style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <div style={{ fontSize: '12px', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Online (1)</div>
        {friends.map(friend => (
          <div key={friend.name} className="glass" style={{ 
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-2px', right: '-2px', width: '10px', height: '10px', borderRadius: '50%', background: friend.status === 'Online' ? '#10b981' : '#6b7280', border: '2px solid #1a1b1e' }}/>
            </div>
            <div>
